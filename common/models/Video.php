...
class Video extends \yii\db\ActiveRecord
{
   ...
   /**
    ...
    public function getVideoLink(){
        return 'http://web.demo-app/storage/videos/'.$this->video_id.'.mp4';
    }
    public function getThumbnailLink(){
        return $this->has_thumbnail ? 'http://web.demo-app/storage/thumbs/'.$this->video_id.'.jpg' : '';
    }
